...
ogr2ogr -f PostgreSQL PG:"dbname=batch3dfier_db\
 host=localhost port=5432 user=batch3dfier password=batch3d_test"\
 ./example_data_batch3d/bag_index.geojson -nln bag_index\
    -skip-failure -a_srs EPSG:28992 -lco FID=gid -lco GEOMETRY_NAME=geom\
    -lco SCHEMA=tile_index

ogr2ogr -f PostgreSQL PG:"dbname=batch3dfier_db\
 host=localhost port=5432 user=batch3dfier password=batch3d_test"\
 ./example_data_batch3d/ahn_index.geojson -nln ahn_index\
    -skip-failure -a_srs EPSG:28992 -lco FID=gid -lco GEOMETRY_NAME=geom\
    -lco SCHEMA=tile_index

ogr2ogr -f PostgreSQL PG:"dbname=batch3dfier_db\
 host=localhost port=5432 user=batch3dfier password=batch3d_test"\
 ./example_data_batch3d/bag_pand.geojson -nln pand\
    -skip-failure -a_srs EPSG:28992 -lco FID=gid -lco GEOMETRY_NAME=geom\
    -lco SCHEMA=bag

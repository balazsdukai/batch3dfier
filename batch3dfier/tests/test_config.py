...
#     ewkb_test = ''
    ...
    poly, ewkb = config.polygon_to_ewkb(dbs, bag_index, file)
...
def test_get_2Dtiles():
    bag_index = ['tile_index', 'bag_index']
    fields_index = ['gid', 'geom', 'unit']
#     ewkb_test = ''
    tiles = config.get_2Dtiles(dbs, bag_index, fields_index, ewkb_test)
    assert tiles == ['25gn1_c1', '25gn1_c2', '25gn1_c3', '25gn1_c4']


def test_find_pc_tiles():
    ahn_index = ['tile_index', 'ahn_index']
    ahn_fields_index = ['gid', 'geom', 'unit']
    tiles = config.find_pc_tiles(dbs, pc_table_index=ahn_index,
                                 pc_fields_index=ahn_fields_index,

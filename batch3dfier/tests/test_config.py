...
@pytest.fixture("module")
def polygons():
    p = {'file': "/home/bdukai/Development/batch3dfier/example_data/extent_small.geojson",
...
def pointcloud():
    p = {'pc_tiles': ['25gn1_a', '25gn1_b'],
         'dataset_dir': "/home/bdukai/Development/batch3dfier/example_data/",
         'dataset_name': "c_{tile}.laz",
         'tile_case': "lower",
         'pc_path': ['/home/bdukai/Development/batch3dfier/example_data/c_25gn1_a.laz',
